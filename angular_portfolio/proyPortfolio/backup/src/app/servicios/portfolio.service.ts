...
//  private apiUrl = "http://localhost:5001/data"
 ...
 // courrentUserSubject: BehaviorSubject<any>;
  ...
  obtenerDatos():Observable<any>{
   ...
   return this.http.get<any>(this.apiUrl+"/get/persona/"+ currentUser.personaId)
  ...
  obtenerEdu():Observable<any>{
    var currentUser=this.autServicio.usuarioAutenticado
   console.log("leyendo datos de portfolio service" );
   return this.http.get<any>(this.apiUrl+"/ver/listaEducacion/"+ currentUser.personaId)
  }

  obtenerExp():Observable<any>{
    var currentUser=this.autServicio.usuarioAutenticado
   console.log("leyendo datos de portfolio service" );
   return this.http.get<any>(this.apiUrl+"/ver/listaExpLaboral/"+ currentUser.personaId)
  }

  obtenerApt():Observable<any>{
    var currentUser=this.autServicio.usuarioAutenticado
   console.log("leyendo datos de portfolio service" );
   return this.http.get<any>(this.apiUrl+"/ver/listaTecnologias/"+ currentUser.personaId)
  }

  obtenerLog():Observable<any>{
    var currentUser=this.autServicio.usuarioAutenticado
   console.log("leyendo datos de portfolio service" );
   return this.http.get<any>(this.apiUrl+"/ver/listaProyecto/"+ currentUser.personaId)
  }
